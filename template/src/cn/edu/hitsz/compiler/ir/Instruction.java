...
public class Instruction {
    ...
    public static Instruction createAssem3(InstructionKind kind, IRVariable result, IRValue lhs, IRValue rhs) {
        return new Instruction(kind, result, List.of(lhs, rhs));
    }

    public static Instruction createAssem2(InstructionKind kind, IRVariable result, IRValue from) {
        return new Instruction(kind, result, List.of(from));
    }

    public static Instruction createAssem1(InstructionKind kind,IRVariable result, IRValue returnValue) {
        return new Instruction(kind, result, List.of(returnValue));
    }
